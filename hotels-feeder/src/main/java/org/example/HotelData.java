...
public class HotelData {
    ...
    public HotelData(String id, String name, String city, String address, double rating, double latitude, double longitude,  String province, List<PriceOffer> priceOffers) {
        this.id = id;
        this.name = name;
        this.city = city;
