...
class HotelDataTest {
    ...
    void shouldAssignCorrectPriceCategory() {
        ...
        assertEquals(HotelData.PriceCategory.LOW, new HotelData("1", "City", "Low", 4.5, 1, 1, low, Instant.now(), "").getCategory());
        assertEquals(HotelData.PriceCategory.MEDIUM, new HotelData("2", "City", "Med", 4.5, 1, 1, medium, Instant.now(), "").getCategory());
        assertEquals(HotelData.PriceCategory.HIGH, new HotelData("3", "City", "High", 4.5, 1, 1, high, Instant.now(), "").getCategory());
    }
    ...
    void shouldCalculateMinAndMaxPrice() {
        ...
        HotelData hotel = new HotelData("1", "Test", "City", 4.2, 0, 0, offers, Instant.now(), "");
